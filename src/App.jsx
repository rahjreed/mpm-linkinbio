  ...
  return (
    <div className="antialiased selection:bg-amber-500/30 min-h-screen text-white relative font-sans overflow-x-hidden">
      ...
      <style>{`
        ...
        .ambient-glow {
          ...
          background: 
            ...
            radial-gradient(circle at 80% 110%, rgba(59, 130, 246, 0.05) 0%, transparent 40%);
          z-index: -1;
        }
        ...
        .glass-card:not(.coming-soon):hover {
          ...
          box-shadow: 0 30px 60px -15px rgba(0,0,0,0.9), 0 0 30px rgba(212, 175, 55, 0.05);
        }
      ...
      <a 
        ...
        className="callista-badge glass-card px-3.5 py-2 rounded-xl flex items-center gap-2.5 group overflow-hidden border-white/5 opacity-80 hover:opacity-100 shadow-2xl"
      >
      ...
      {/* Main Content Start */}
      <main className="max-w-2xl mx-auto px-6 pt-4 md:pt-10 pb-20 relative z-10">
        ...
        {/* Hero Section */}
        <section className="text-center mb-16 reveal active">
          {/* Brand Symbol Profile Size */}
          <div className="flex justify-center mb-6">
            <div className="relative p-1.5 rounded-full border border-amber-500/30 bg-gradient-to-b from-amber-500/20 to-transparent shadow-[0_0_40px_rgba(212,175,55,0.1)]">
              <img 
                src="https://images.travelprox.com/mrplumberman/symbol.png" 
                alt="Plumber Man Seal" 
                className="w-24 h-24 md:w-32 md:h-32 object-contain filter drop-shadow-[0_0_20px_rgba(212,175,55,0.3)]"
              />
            </div>
          </div>
          ...
          <div className="max-w-xl mx-auto">
            ...
            <p className="mono text-[9px] md:text-[10px] font-bold text-amber-500 uppercase tracking-[0.6em] mb-4 opacity-80">
              Vitality • Energy • Performance
            </p>

            <h2 className="text-2xl md:text-4xl font-black text-white mb-8 leading-tight tracking-tight uppercase">
              Keep the pipes <span className="text-amber-500">pipin’</span>
            </h2>
            
            <div className="flex flex-col gap-8 items-center">
              <p className="text-slate-300 text-base md:text-lg max-w-sm mx-auto leading-relaxed font-medium">
              ...
              <div className="relative group w-full max-w-[260px]">
                <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-amber-600 text-black text-[8px] font-black px-2.5 py-0.5 rounded shadow-xl z-20 tracking-widest uppercase">
                  ENTER STORE
                </span>
                <button 
                  onClick={handleManualRedirect}
                  className="bg-amber-500 text-black w-full px-6 py-4.5 rounded-xl font-black text-base flex items-center justify-center gap-3 group hover:scale-[1.03] transition-all duration-300 shadow-[0_20px_50px_-10px_rgba(212,175,55,0.4)] uppercase italic"
                >
        ...
        {/* Updated Mailing List Form Section */}
        <section className="mb-20 reveal text-center">
          <div className="max-w-md mx-auto p-8 glass-card rounded-[2.5rem] shadow-[0_0_80px_rgba(0,0,0,0.7)] border-amber-500/15">
            ...
            <h2 className="text-xl font-black mb-1 uppercase tracking-tight italic text-amber-500">Rewards Protocol</h2>
            <p className="text-slate-200 mb-6 text-sm font-bold leading-relaxed max-w-[280px] mx-auto">
              Free product giveaways and exclusive mailing list discounts <span className="text-amber-500">up to 50% off.</span>
            </p>
            ...
            <div className="kit-form-container">
              ...
              >
                <div data-style="clean">
                  ...
                  <div data-element="fields" data-stacked="false" className="seva-fields formkit-fields flex flex-col gap-2.5">
            ...
            <p className="mt-6 text-[9px] mono text-slate-500 uppercase tracking-widest">Priority status for active subscribers only</p>
          </div>
        </section>
        ...
        <section id="shop" className="mb-20 reveal">
          <div className="flex items-center justify-between mb-8 px-1">
            <h3 className="mono text-[10px] uppercase tracking-[0.5em] text-slate-500 font-bold italic">Engineering Catalog</h3>
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-400 text-xs leading-relaxed font-medium">Flagship protocol for optimal blood flow and endurance.</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                <h4 className="text-lg font-black text-white mb-0.5 group-hover:text-amber-500 transition-colors italic uppercase tracking-tight">PRIME TIME</h4>
                <p className="text-slate-400 text-xs leading-relaxed font-medium">Fast-acting booster designed for high-stakes performance.</p>
              </div>
            ...
            <div className="glass-card p-6 rounded-[2rem] flex flex-col md:flex-row md:items-center gap-5 group opacity-40 border-white/5 bg-white/[0.01]">
              <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-slate-600 shrink-0">
                <Lock className="w-6 h-6" />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-0.5">
                  <h4 className="text-lg font-black text-white/50 italic uppercase tracking-tight">MACA DADDY</h4>
                  <span className="text-[8px] font-black bg-white/10 text-slate-500 border border-white/10 px-2 py-0.5 rounded uppercase tracking-wider">Locked</span>
                </div>
                <p className="text-slate-600 text-xs leading-relaxed font-medium">Ultimate natural drive and hormone optimization.</p>
              </div>
              <span className="text-[8px] font-black text-slate-600 border border-white/10 px-4 py-2 rounded-lg cursor-not-allowed uppercase tracking-widest">Pending</span>
            </div>
          </div>
        </section>
        ...
        <section id="pressure" className="mb-20 reveal">
          <div className="glass-card p-3 rounded-[3rem] relative overflow-hidden group border-amber-500/25 shadow-[0_40px_100px_-20px_rgba(212,175,55,0.15)]">
            <div className="bg-slate-950 rounded-[2.5rem] overflow-hidden border border-white/10 aspect-video md:aspect-[21/9] flex items-center justify-center relative">
              ...
              <div className="text-center z-20 px-8">
                ...
                <p className="text-slate-300 text-[9px] md:text-xs max-w-sm mx-auto font-black leading-relaxed uppercase tracking-[0.2em]">
            ...
            <div className="p-8 text-center">
              <div className="flex flex-wrap justify-center gap-6 mb-8">
                <div className="flex items-center gap-2 text-slate-300"><Check className="w-4 h-4 text-amber-500" /> <span className="text-[8px] font-black uppercase tracking-widest">Vitality Support</span></div>
                <div className="flex items-center gap-2 text-slate-300"><Check className="w-4 h-4 text-amber-500" /> <span className="text-[8px] font-black uppercase tracking-widest">Discrete Shipping</span></div>
                <div className="flex items-center gap-2 text-slate-300"><Check className="w-4 h-4 text-amber-500" /> <span className="text-[8px] font-black uppercase tracking-widest">Fast Delivery</span></div>
              </div>
              <button 
                onClick={handleManualRedirect}
        ...
        <footer className="pt-12 border-t border-white/5 text-center reveal">
          <div className="flex justify-center gap-8 mb-12">
            <a href="#" className="text-slate-600 hover:text-amber-500 transition-all transform hover:-translate-y-1"><Instagram className="w-5 h-5" /></a>
            <a href="#" className="text-slate-600 hover:text-amber-500 transition-all transform hover:-translate-y-1"><Music className="w-5 h-5" /></a>
            <a href="#" className="text-slate-600 hover:text-amber-500 transition-all transform hover:-translate-y-1"><Mail className="w-5 h-5" /></a>
          ...
          <div className="mono text-[8px] text-slate-700 font-bold uppercase tracking-[0.5em] space-y-6">
